...
- Run at: 2026-09-17T11:19:36.449Z
- Base URL: `https://sdk.api.pollar.xyz`
- Origin sent: `http://localhost:3005`
...
| Ramp countries (publishable key) | BLOCKED | `403 {"code":"ORIGIN_NOT_ALLOWED","success":false}` |
| Bolivia BOB off-ramp quote | BLOCKED | `403 {"code":"ORIGIN_NOT_ALLOWED","success":false}` |
